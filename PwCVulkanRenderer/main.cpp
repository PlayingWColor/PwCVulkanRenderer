...
const std::vector<Vertex> vertices = {
	{{-0.4, -0.5}, {0.0f, 0.0f, 1.0f}},
	{{0.4, -0.5}, {0.0f, 1.0f, 0.0f}},
...
private:
	...
	void createInstance() 
	{
		...
		//create application info for instance
		...
		//create instance info, including application info
		...
		//create debug info for validation layers
		...
		int requiredExtensionsAvailable = 0;
		for (const auto& extension : extensionsAvailable) {

			for (const auto& extensionReq : extensionsRequired) {
		...
		std::cout << requiredExtensionsAvailable << " of " << extensionsRequired.size() << " required extensions are available\n";
	...
	{
		auto vertShaderCode = readFile("shaders/simpleShaderVert.spv");
		auto fragShaderCode = readFile("shaders/simpleShaderFrag.spv");
